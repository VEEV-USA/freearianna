...
const criminals = [
    ...
    },
    {
        img: Image7,
        name: 'Katrina Ohde',
        action: <p>A corrupt district attorney in San Jose, Santa Clara, California that has betrayed the public trust. Must be disbarred.<br/><a href='recallnow'>Sign Petition</a></p>
    },
    {
        img: Image8,
        name: 'Joe Perez',
