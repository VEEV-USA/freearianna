      ...
      <Container style={{ marginTop: 21 }}>
        <Row gutter={[40, 40]}>
          ...
          <Col lg={6} md={12} sm={12} span={24}>
            ...
            >
              <CardTitle
                onClick={() => open_data_url_window(pdf1)}
                style={{ color: "rgb(206, 61, 175)", cursor: "pointer" }}
              >
                {person.pdf1_title}
              </CardTitle>
            </Card>
          ...
          <Col lg={6} md={12} sm={12} span={24}>
            ...
            >
              <CardTitle
                onClick={() => open_data_url_window(pdf2)}
                style={{ color: "rgb(206, 61, 175)", cursor: "pointer" }}
              >
                {person.pdf2_title}
              </CardTitle>
          ...
          <Col lg={6} md={12} sm={12} span={24}>
            ...
            >
              <CardTitle
                onClick={() => open_data_url_window(pdf3)}
                style={{ color: "rgb(206, 61, 175)", cursor: "pointer" }}
              >
                {person.pdf3_title}
              </CardTitle>
          ...
          <Col lg={6} md={12} sm={12} span={24}>
            ...
            >
              <CardTitle
                onClick={() => open_data_url_window(pdf4)}
                style={{ color: "rgb(206, 61, 175)", cursor: "pointer" }}
              >
                {person.pdf4_title}
              </CardTitle>
...
export default connect(mapStateToProps, mapDispatchToProps)(TakeActionContent);
