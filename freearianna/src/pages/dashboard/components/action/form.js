...
const TakeActionForm = ({
  ...
  const handleCreate = async e => {
    e.preventDefault();
    const createprofile = await dispatch(
      createProfile(
        {
            ...
            <Space>
              ...
              >
                <Input
                  size="large"
                  name="signatures_Require"
                  value={signatures_Require}
                  onChange={e => handleChange(e)}
                  placeholder="Signatures Require"
                />
              </Item>
              <Item
                name="license"
...
export default connect(mapStateToProps, mapDispatchToProps)(TakeActionForm);
